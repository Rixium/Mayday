...
namespace GeonBit.UI
{
    ...
    public class DrawUtils
    {
        ...
        public virtual void DrawImage(SpriteBatch spriteBatch, Texture2D texture, Rectangle destination, Color? color = null, float scale = 1f, Rectangle? sourceRect = null, float rotation = 0f, Vector2? origin = null)
        {
            // default color
            ...
            // draw image
            spriteBatch.Draw(texture, destination, src, (Color)color, rotation, actualOrigin, SpriteEffects.None, 0f);
        }
        ...
        /// <param name="rotation">Optional rotation of the entity.</param>
        public virtual void DrawSurface(SpriteBatch spriteBatch, Texture2D texture, Rectangle destination, Vector2 textureFrameWidth, float scale = 1f, Color? color = null, float frameScale = 1f, float rotation = 0f)
        {
            // default color
            color = FixColorOpacity(color);
            ...
            if (needTopBottomStrips && needSideStrips)
            {
                ...
                do
                {
                    ...
                    do
                    {
                        ...
                        // draw center segment
                        spriteBatch.Draw(texture, destRect, srcRect, (Color)color, rotation, Vector2.Zero, SpriteEffects.None, 0f);
