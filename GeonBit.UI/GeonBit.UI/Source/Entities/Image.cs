...
namespace GeonBit.UI.Entities
{
    ...
    public class Image : Entity
    {
        ...
        /// <summary>
        /// Makes sure the image is always a square, height matches width.
        /// </summary>
        ...
        override protected void DrawEntity(SpriteBatch spriteBatch, DrawPhase phase)
        {
            ...
            switch (DrawMode)
            {
                ...
                case ImageDrawMode.Panel:
                    UserInterface.Active.DrawUtils.DrawSurface(spriteBatch, Texture, _destRect, FrameWidth, Scale, FillColor, 1f);
                    break;
